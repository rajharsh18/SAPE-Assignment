...
export default function RoomsPage() {
  ...
  const handleDelete = async (room: Room) => {
    if (
      !confirm(
        `Delete room ${room.roomNumber}? This will also delete ${room._count.slots} associated time slots.`,
      )
    )
      return;
    ...
    <div className="page-section">
      ...
      <DataTable
        ...
        columns={[
          ...
          },
          {
            ...
            header: "Department",
            render: (r) => (
              <span className="text-text-secondary">{r.department.name}</span>
            ),
          },
          {
            key: "type",
            header: "Type",
            render: (r) => (
              <Badge variant={roomBadgeVariant(r.type)}>{r.type}</Badge>
            ),
          },
          {
            key: "capacity",
      ...
      >
        <BulkImport
          ...
          hint="Columns: roomNumber | departmentCode | capacity | type"
        />
      </Modal>
    </div>
  );
