...
const filePath = process.argv[2] || "/data/samayak-uploads/210cadd3-867c-4d11-baba-075a8e0bab24.pdf";
...
try {
  ...
  console.log(JSON.stringify({ status: updated?.status, errors: updated?.errors }));
}
